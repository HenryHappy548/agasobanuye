  ...
  const getVideoInfo = (id: string) => {
    const videos: Record<string, { 
      ...
      "ringslb": {
        ...
        embedCode: '<iframe width="1280" height="720" style="border:0;" scrolling="no" src="https://go.screenpal.com/player/cTl6qYnYbo0?title=0&controls=1&a=1&share=1&download=1&embed=1&cl=1&width=1280&height=720&overlays=1&ff=1" allowfullscreen="true"></iframe>',
          host: "Gaheza",
        downloadLinks: [
      ...
      "ringsla": {
        ...
        embedCode: '<iframe width="1280" height="720" style="border:0;" scrolling="no" src="https://go.screenpal.com/player/cTlXfUnYFOS?title=0&controls=1&share=1&download=1&embed=1&cl=1&width=1280&height=720&overlays=1&ff=1" allowfullscreen="true"></iframe>',
          host: "Gaheza",
        downloadLinks: [
